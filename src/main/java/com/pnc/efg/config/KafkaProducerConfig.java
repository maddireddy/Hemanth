...
public class KafkaProducerConfig {
    ...
    @Bean
    public KafkaTemplate<String, EfgPlatformList> kafkaTemplate(ProducerFactory<String, EfgPlatformList> pf) {
